...
function SportsWidget () {
  ...
  function injectUI () {
    ...
    for (var sport in schedules) {
      var scheduleVboxId = Sports[sport];
      var scheduleVbox = document.getElementById(scheduleVboxId);
  ...
  return {
    ...
    widgetCreated: function (node) {
      ...
      img.setAttribute("src", "http://files.danpoggi.com/icon.png");
      ...
      lbl.setAttribute("value", "MSU Sports");
